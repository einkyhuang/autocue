<template>
  <div class="app-container">
    <el-row type="flex" justify="center" align="middle">
      <h2>AI 标签生成器 <sub><el-link href="https://tinygeeker.gitee.io/menu/autocue/?from=https://tinygeeker.github.io/menu/autocue/" target="_blank" type="primary"></el-link></sub></h2>
    </el-row>
